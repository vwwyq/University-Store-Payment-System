            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
              <div className="flex flex-col space-y-4 rounded-lg border p-6 bg-background">
                ...
                <p className="text-muted-foreground">
                  "I saved over $300 on textbooks this semester by buying them from other students on Campus
                  Marketplace!"
                </p>
              </div>
              <div className="flex flex-col space-y-4 rounded-lg border p-6 bg-background">
                ...
                <p className="text-muted-foreground">
                  "I furnished my entire dorm room with items from Campus Marketplace. It's so convenient to buy from
                  other students!"
                </p>
              </div>
              <div className="flex flex-col space-y-4 rounded-lg border p-6 bg-background">
                ...
                <p className="text-muted-foreground">
                  "I made over $500 selling items I no longer needed. The platform is super easy to use and secure."
                </p>
              </div>
            </div>
          </div>
