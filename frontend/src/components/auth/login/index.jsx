    ...
    return (
        <div>
            ...
            <main className="w-full h-screen flex justify-center items-center">
                <div className="w-96 p-6 shadow-xl border rounded-xl text-gray-600 space-y-5">
                    ...
                    <form onSubmit={onSubmit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent border rounded-lg outline-none focus:border-indigo-600 shadow-sm transition duration-300"
                            />
                        </div>
                    ...
                    <div className="flex items-center text-center">
                        <div className="border-b-2 flex-grow mr-2"></div>
                        <div className="text-sm font-bold">OR</div>
                        <div className="border-b-2 flex-grow ml-2"></div>
                    </div>
